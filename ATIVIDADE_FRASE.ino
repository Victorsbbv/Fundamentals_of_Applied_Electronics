...
void loop() {
  ...
  display.setCursor(30, 10); //Definição de onde o texto será escrito. Lembre se que: linha, coluna;
  display.print("0  0"); //Texto a ser escrito;
   display.setCursor(45, 25); //Definição de onde o texto será escrito. Lembre se que: linha, coluna;
  display.print("V"); //Texto a ser escrito;
  display.setCursor(30, 45);
  display.print("____"); //Texto a ser escrito;
  display.display();
}
